...
data_mode = 'topdown'
data_root = 'data/Measurement_2/'

# 三角板关键点检测数据集-元数据
dataset_info = {
    'dataset_name':'_Keypoint_coco',
    'classes':'measurement',
    'paper_info':{
        'author':'Magia',
        ...
        'container':'OpenMMLab',
        'year':'2024',
        'homepage':'https://github.com/MagiaClay'
    },
    'keypoint_info':{
        0:{'name':'num_value','id':0,'color':[0,0,255],'type': '','swap': ''}
    },
    'skeleton_info': {
        0: {'link':('num_value','num_value'),'id': 0,'color': [100,150,200]}
    }
}
...
#         in_featuremap_size=(16, 16), # 此处也要等比例缩放
